...
parquet_parrots <- read_parquet("parrots") # alphabetically ordered, filtered NA genus data 
parquet2_parrots <- read_parquet("parrots2") # not alphabetically ordered, random data 
```
