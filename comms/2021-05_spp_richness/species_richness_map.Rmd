---
title: "(Poorly) estimating species richness from atlas data"
description: |
...
The following code creates a map roughly estimating species richness across Australia.

<aside>
```{r author image, echo = FALSE}
library(here)
image_path <- here("comms", "images", "martin.jpg")
htmltools::withTags(
