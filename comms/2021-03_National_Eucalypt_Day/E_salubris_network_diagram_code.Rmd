...
description: |
  A plot of E. salubris for National Eucalypt Day 2021
author:
...
See the the [original R script](https://github.com/AtlasOfLivingAustralia/science/blob/main/comms/2021-03_National_Eucalypt_Day/E_salubris_network_diagram_code.R) for this plot
...
occurrences %>% filter(is.na(colour_index))
```
...
colour_graph <- graph_from_edgelist(graph_df)             # make network graph
