...
species_counts <- atlas_counts(taxa = select_taxa(c("agnatha", "chondrichthyes", "Osteichthyes")),
...
species_names$vernacular_name[species_names$species == 'Heterodontus portusjacksoni'] <- 'Port Jackson Shark'
...
species_counts %>%
  ...
  scale_fill_manual(values = c(
    "Heterodontus portusjacksoni" = "#E06E53",
    "Trygonoptera imitata" = pilot_color("blue"),
    "Trygonoptera testacea" = pilot_color("blue"),
    "Myliobatis tenuicaudatus" = pilot_color("blue")
  )) + 
  theme_pilot(axes = "b",
                     grid = "v") + 
  coord_flip() + 
...
```{r, eval = FALSE}
ggsave(here::here("comms", "2021-12-01_species-dataviz-2021", "plots", "top-fish-2021.png"),
