...
**Add a little more info here. Because records are occurring in 2 states that have pretty extreme climate gradients, we thought it would be interesting to check whether there were differences in the time of year records were collected, which might be another important difference in the data in SA compared to NT**
 ...
 **I think you need to try to answer this question based on these maps. I think just comment on how you can see many more records in protected areas (and on the protected side of the Dog Fence) than outside of these areas, and comment on what this means about the limitations of our knowledge of dingoes**
