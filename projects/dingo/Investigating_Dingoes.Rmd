...
Citizen records can also be unreliable because they involve bias where alot recordings are usually around rivers, national parks and along roads, which doesn't truly represent the distribution of a species rather only where humans and dingoes both occur. 
...
Why is it only state organisations are recording dingoes, why aren't they been recorded in other states and why are the records in the NT disproportionality higher? One explanation could be that the public has no invested interest in recording dingos but would rather avoid the species. Each state also has different legislation on the dingo and some states may value this species more than others. For example, the Northern Territory is the only state in Australia that recognizes it as a protected species, however outside of protected areas permits can still be applied for to take or remove wildlife. In other states such as Western Australia, New South Wales it is declared a pest species. So now we start to see a correlation between states having it a protected species with the highest amount of observations verse states that have the lowest amount recognise it as a pest species. 
