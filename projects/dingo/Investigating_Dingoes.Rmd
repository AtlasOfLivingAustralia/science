...
**all packages should be loaded at the top of the document. I'd suggest combining the code in the above chunk and the code to make `BarPlot`, with a final plot of the two side-by-side**
```{r}
library(ggplot2)
library(patchwork)
```
...
**I'm remembering I never figured this out, sorry. I will have a look tomorrow**
