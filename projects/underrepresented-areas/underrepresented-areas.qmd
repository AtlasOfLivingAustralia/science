---
title: "underrrepresented-areas"
format: html
editor: visual
---

#Underrepresented ALA regions 
...
** removing birds, viruses and protozoa ** 
...
removspeciesmap <- ggplot() + 
  ...
  annotate("text", 
           x = 133, 
           y = -45.5, 
           label = expression("Records per species per km² (no birds,viruses or protozoa)"),
           size = 4) +
  coord_sf(xlim = c(110, 155), ylim = c(-45, -10)) +
  theme_void() +
  theme(legend.position = "bottom",
