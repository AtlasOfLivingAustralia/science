...
{write.csv(data.frame(correct_name = "Limnodynastes dumerilii",
                      provided_name = "Limnodynastes dumerilii",
                      synonyms = NA,
                      common_name = "Eastern Banjo Frog",
                      state = "ACT",
                      lga = "SWAN HILL RURAL CITY, BRIMBANK CITY"),
           paste0(dir_path, "/list1_list.csv"),
           row.names = FALSE)}

##### Collate lists() ######
path <- paste0(dir_path, "/")
list_suffix <- "_list"
