...
Now lets create a monthly animation of the east coast map.
...
This post has shown just one of the interesting ways you can use the ALA data and using this code we have mapped the species distribution of nudibranchs. Theoretically, you could switch Nudibranchs out and discover the potential distribution of almost any species, although it will not necessarily be accurate as the variables and input data are different for every species. There are also always limitations and errors within the model. Therefore, the maps and SDM presented in this post should be considered with these limitations in mind. 
