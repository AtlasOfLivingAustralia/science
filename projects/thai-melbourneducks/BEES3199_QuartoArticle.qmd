...
It is far easier to scale each value with everything organised into columns according to year. We can achieve this by using *pivot_wider*, and then scaling each column according to the corresponding value in the table of total records we just created. 
...
imgDuck <- circle_crop("https://ala-images.s3.ap-southeast-2.amazonaws.com/store/7/3/e/9/ceeac92a-2772-477f-8bc2-ebe7480b9e37/original")
```
...
#| echo: false
#Save
png(file="C:/Users/thair/Downloads/Ducksbyweek_plot.jpg",
...
:::{.column-body-outset}
![Final Plot](C:/Users/thair/Downloads/Ducksbyweek_plot.jpg)
:::