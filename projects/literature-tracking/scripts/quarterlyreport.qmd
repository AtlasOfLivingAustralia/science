...
#| message: false
#| warning: false
data <- read_csv(here("projects", "literature-tracking", "data", "1nov23.csv"))
```
...
publicationbymonth <- dataclean2 |>
  ...
  filter(date_added_clean <= ymd("2023-11-01")) |>
...
The number reported will be (a + b). Here, that is 91 papers citing and using the ALA.
